$.sidebarMenu = function(menu) {
  ...
  $(menu).on('click', 'li a', function(e) {
    ...
    if (checkElement.is('.treeview1-menu') && checkElement.is(':visible')) {
    ...
    else if ((checkElement.is('.treeview1-menu')) && (!checkElement.is(':visible'))) {
      //Get the parent menu
    ...
    if (checkElement.is('.treeview1-menu')) {
      e.preventDefault();
    }
  });
}
